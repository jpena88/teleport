...
func (a *fakeLog) SearchSessionEvents(fromUTC, toUTC time.Time, limit int, order types.EventOrder, startKey, withParticipant string) ([]apievents.AuditEvent, string, error) {
	return nil, "", trace.NotFound("")
}
